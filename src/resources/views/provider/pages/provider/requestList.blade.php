    ...
    <table class="table table-bordered table-hover">
      ...
      @endif ">
        ...
        <td>
          ...
          @endphp
          @endif
          <a href="{{ $url }}" target="_blank">Follow Link</a>
        </td>
        ...
        <td>
          ...
          <button disabled data-toggle="modal" data-target="#allModal{{$key}}" class="btn btn-sm btn-success">{{ $request->status }}</button>
          @elseif($request->status == 'rejected')
          <button disabled data-toggle="modal" data-target="#allModal{{$key}}" class="btn btn-sm btn-danger">{{ $request->status }}</button>
    ...
    <table class="table table-bordered table-hover">
      ...
      <tr>
        ...
        <td>
          ...
          <button data-toggle="modal" data-target="#confirmedModal{{$key}}" class="btn btn-sm btn-success">{{ $request->status }}</button>
          @elseif($request->status == 'completed')
          <button disabled data-toggle="modal" data-target="#confirmedModal{{$key}}" class="btn btn-sm btn-success">{{ $request->status }}</button>
          @elseif($request->status == 'rejected')
          <button data-toggle="modal" data-target="#confirmedModal{{$key}}" class="btn btn-sm btn-danger">{{ $request->status }}</button>
          {{-- @elseif($request->status == 'cancelled')
             <button data-toggle="modal" data-target="#confirmedModal{{$key}}" class="btn btn-sm btn-danger">{{ $request->status }}</button> --}}
    ...
    <table class="table table-bordered table-hover">
      ...
      <tr>
        ...
        <td>
          ...
          @elseif($request->status == 'rejected')
          <button disabled data-toggle="modal" data-target="#rejectedModal{{$key}}" class="btn btn-sm btn-danger">{{ $request->status }}</button>
          {{-- @elseif($request->status == 'cancelled')
